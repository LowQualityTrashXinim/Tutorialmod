...
namespace Tutorialmod.Items.Weapon.RFlamethrowerClass
{
    public class Flamethrower : ModItem
    {
        ...
        {
			DisplayName.SetDefault("Ronson_WPX_Incinerator");
            Tooltip.SetDefault("This seem to be quite unrealiable\nHas 88% chance to not consume ammo");
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.noMelee = true; 
            Item.knockBack = 1.5f; 
            Item.value = 100; // how much the item sells for (measured in copper)
            Item.rare = ItemRarityID.Blue; // the color that the item's name will be in-game
            Item.autoReuse = true;
            Item.shoot = ModContent.ProjectileType<FlamethrowerP>();
            Item.shootSpeed = 20f;
            Item.useAmmo = AmmoID.Gel; // The "ammo Id" of the ammo item that this weapon uses. Note that this is not an item Id, but just a magic value.
        }
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			Vector2 muzzleOffset = Vector2.Normalize(new Vector2(speedX, speedY)) * 79f;
