...
namespace Tutorialmod.Items.Weapon.RGunClass
{
    public class SniperRifle : ModItem
    {
        ...
        {
            Tooltip.SetDefault("Till you die");
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.height = 53; // hitbox height of the item
		...
		{
			player.AddBuff(Mod.Find<ModBuff>("BulletHell").Type, 60);
		}
		...
		{
			Projectile.NewProjectile(position.X, position.Y, speedX, speedY, Mod.Find<ModProjectile>("SuperChargedP").Type, damage, knockBack, player.whoAmI);
			Projectile.NewProjectile(position.X, position.Y, speedX, speedY, Mod.Find<ModProjectile>("SuperChargedP").Type, damage, knockBack, player.whoAmI);
			Projectile.NewProjectile(position.X, position.Y, speedX, speedY, Mod.Find<ModProjectile>("SuperChargedP").Type, damage, knockBack, player.whoAmI);
			return true;
		}
