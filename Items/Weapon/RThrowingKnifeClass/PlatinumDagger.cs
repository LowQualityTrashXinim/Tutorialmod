...
namespace Tutorialmod.Items.Weapon.RThrowingKnifeClass
{
    public class PlatinumDagger : ModItem
    {
        ...
        {
            Tooltip.SetDefault("Really expensive dagger");
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.height = 39; // hitbox height of the item
            ...
            Item.useStyle = 1; // how you use the item (swinging, holding out, etc)
			...
			Item.shoot = Mod.Find<ModProjectile>("PlatinumDaggerP").Type;
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            {
                Projectile.NewProjectile(position.X, position.Y, speedX, speedY, Mod.Find<ModProjectile>("PlatinumDaggerP").Type, damage, knockBack, player.whoAmI);
            }
            if (player.altFunctionUse == 2)
            {
                ...
                for (int i = 0; i < numberProjectiles; i++)
                {
                    ...
                    Projectile.NewProjectile(position.X, position.Y, perturbedSpeed.X, perturbedSpeed.Y, Mod.Find<ModProjectile>("PlatinumDaggerP").Type, damage, knockBack, player.whoAmI);
                }
            }
                return true;
        }
