...
{
    public class WoodStick : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Not to be with confused with none-combat and woodenstick");
        }
        ...
        public override void SetDefaults()
        {
			...
			Item.shoot = Mod.Find<ModProjectile>("WoodStickP").Type;
