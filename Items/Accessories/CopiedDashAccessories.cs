...
namespace TutorialMod.Items.Accessories
{
	...
	public class CopiedDashAccessories : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("This is a copied accessory that got buff to the point of OP." +
	...
	public class ExampleDashPlayer : ModPlayer
	{
		...
		public static readonly int MAX_DASH_DELAY = 20;
		public static readonly int MAX_DASH_TIMER = 40;
		...
		public override void ResetEffects()
		{
			...
			for(int i = 3; i < 8 + Player.extraAccessorySlots; i++)
			{
				...
				if(item.type == ItemType<CopiedDashAccessories>())
